...
#   pragma comment(lib, "Graphics_x64d.lib")
#elif defined(_M_X64) && !defined(_DEBUG)
#   pragma comment(lib, "Graphics_x64.lib")
#elif defined(_M_IX86) && defined(_DEBUG)
#   pragma comment(lib, "Graphics_x86d.lib")
#elif defined(_M_IX86) && !defined(_DEBUG)
#   pragma comment(lib, "Graphics_x86.lib")
#else
...
#ifndef _LIB
#if defined(_M_X64) && defined(_DEBUG)
#   pragma comment(lib, "Graphics_x64d_md.lib")
#elif defined(_M_X64) && !defined(_DEBUG)
#   pragma comment(lib, "Graphics_x64_md.lib")
#elif defined(_M_IX86) && defined(_DEBUG)
#   pragma comment(lib, "Graphics_x86d_md.lib")
#elif defined(_M_IX86) && !defined(_DEBUG)
